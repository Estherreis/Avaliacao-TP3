...
namespace AvaliacaoA1.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Não é possível criar uma instância de '{nameof(IdentityUser)}'. " +
                    $"Certifique-se de que '{nameof(IdentityUser)}' não é uma classe abstrata e tem um construtor sem parâmetros, ou " +
                    $"altere a página de registro em /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("A interface padrão exige um armazenamento de usuário com suporte a email.");
            }
